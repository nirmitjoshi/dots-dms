...
defaults = {
	...
	controls =
	'menu,gap,<video,audio>subtitles,<has_many_audio>audio,<has_many_video>video,gap,space,<video,audio>speed,space,loop-file,gap,fullscreen',
	controls_size = 32,
	controls_margin = 8,
	controls_spacing = 2,
